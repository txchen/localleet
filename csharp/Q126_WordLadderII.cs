...
namespace LocalLeet
{
    public class Q126
    {
        ...
        [Fact]
        public void Q126_WordLadderII()
        {
            TestHelper.Run(input => TestHelper.Serialize(FindLadders(input[0].Deserialize(),
                    input[1].Deserialize(), input[2].ToStringArray())),
                specialAssertAction: AreStringArrayArrayEqual);
        }
    }
}
